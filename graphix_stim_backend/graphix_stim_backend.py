...
def presimulate_pauli(
    pattern: Pattern, *, branch: Mapping[int, Outcome] | None = None, leave_input: bool = False, stacklevel: int = 1
) -> PresimulatedPattern:
    ...
    pauli_pattern.simulate(backend, measure_method=measure_method, optimized=False)
